...
@section('page-content')
    <form class="add-vac @if($errors->any()) {{'form-invalid'}} @endif"
        ...
        @csrf
        @method('PUT')
        <h2 class="add-vac__title">Редактировать вакансию</h2>
        ...
        <div class="add-vac__group @error('price') form__item--invalid @enderror">
            ...
            @error('price')
            <span class="form__error">Укажите зарплату</span>
            @enderror
        </div>
        <button type="submit" class="form-submit">Редактировать вакансию</button>
    </form>
@endsection
